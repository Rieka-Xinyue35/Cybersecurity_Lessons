...
# json_txt = '{"Name": "Olive", "Age": 14, "Occupation": "Student"}'
#
# # Converting json to python (LOADS)
# x = json.loads(json_txt)
# print(x)
...
#     "Age": "14",
#     "Occupation": "Student",
#     "School": "Agape Academy International"
# }
# y = json.dumps(dict_txt, indent = 4, separators = (":"," = "), sort_keys=True)
# print(y)

# # Loading json file in python.
# with open("sample_qa_dataset_json.json") as json_file:
...
with open("dictionary.json", "w") as json_file:
    json.dump(dictionary_dataset, json_file, indent=4, sort_keys = True)
